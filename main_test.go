...
// 	workerInput <- 0
// 	SingleHash(workerInput, workerOutput)
// 	out := <-workerOutput
// 	// fmt.Println(out.(string))
// 	if "4108050209~502633748" != out.(string) {
// 		t.Error("Bla")
// 	}
// }
...
// 	workerInput := make(chan interface{}, 1)
// 	workerOutput := make(chan interface{}, 1)
// 	workerInput <- "4108050209~502633748"
// 	MultiHash(workerInput, workerOutput)
// 	out := <-workerOutput
// 	// fmt.Println(out.(string))
// 	if "29568666068035183841425683795340791879727309630931025356555" != out.(string) {
// 		t.Error("Bla")
// 	}
// }
...
func TestPipeline(t *testing.T) {
	...
	freeFlowJobs := []job{
		job(func(in, out chan interface{}) {
			...
			fmt.Println("currece", currRecieved)
			// в чем тут суть
